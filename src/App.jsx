...
- Formate a resposta usando markdown com seções claras usando ## para títulos e • para listas.`;
  ...
  while (i < lines.length) {
    ...
    if (line.startsWith("## ")) {
      ...
      const formatted = line.replace(/\*\*(.*?)\*\*/g, (_, m) =>
        `<strong style="color:#F59E0B;font-weight:600">${m}</strong>`
      );
      elements.push(
        <p key={i} style={{ color: "#D1D5DB", fontSize: "0.82rem", lineHeight: "1.6", margin: "0.15rem 0" }}
...
export default function App() {
  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <div>
          <div style={{
            ...
            fontFamily: "'IBM Plex Mono', monospace",
          }}>Normas Técnicas ABNT/NBR</div>
          <div style={{ fontSize: "0.65rem", color: "#6B7280", letterSpacing: "0.05em" }}>
            Especialista em Engenharia e Qualidade
          </div>
        </div>
      ...
      {/* Main */}
      <main style={{
        flex: 1, overflowY: "auto", paddingTop: "80px", paddingBottom: "140px",
        position: "relative", zIndex: 1,
      }}>
        {isEmpty ? (
          <div style={{
            maxWidth: "680px", margin: "0 auto", padding: "2rem 1rem",
            ...
            <div style={{ textAlign: "center", marginTop: "1rem" }}>
              <div style={{
                ...
                background: "linear-gradient(135deg, rgba(245,158,11,0.2), rgba(146,64,14,0.2))",
              ...
              <h1 style={{
                fontSize: "1.4rem", fontWeight: "700", color: "#F9FAFB",
                marginBottom: "0.5rem", lineHeight: "1.3",
              }}>
                Consultor de Normas Técnicas
              </h1>
              <p style={{ fontSize: "0.82rem", color: "#6B7280", lineHeight: "1.6", maxWidth: "420px" }}>
                Consulte normas ABNT/NBR, especificações técnicas e procedimentos de execução
                para construção civil, indústria e engenharia.
              </p>
            </div>
            ...
            <div style={{ width: "100%" }}>
              <p style={{
                fontSize: "0.7rem", color: "#4B5563", textTransform: "uppercase",
            ...
            {messages.map((msg, idx) => (
              <div key={idx} style={{
                ...
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: "0.75rem",
                  boxShadow: msg.role === "assistant" ? "0 0 12px rgba(245,158,11,0.2)" : "none",
                }}>
                  {msg.role === "user" ? "👤" : "⚙"}
                </div>
                {/* Bubble */}
        ...
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
              ...
              {QUICK_QUERIES.slice(0, 4).map(q => (
                <button key={q.label} onClick={() => sendMessage(q.query)}
                  style={{
                    ...
                    color: "#9CA3AF", fontSize: "0.68rem", cursor: "pointer",
          ...
          <div style={{
            ...
            <textarea
              ...
              onKeyDown={handleKey}
              placeholder="Ex: Qual a norma para impermeabilização de piscinas?"
              rows={1}
              style={{
                flex: 1, background: "transparent", border: "none", outline: "none",
                color: "#E5E7EB", fontSize: "0.82rem", lineHeight: "1.5",
                resize: "none", fontFamily: "'IBM Plex Sans', sans-serif",
                minHeight: "24px",
              }}
            />
            <button
              ...
              style={{
                ...
                boxShadow: input.trim() && !loading ? "0 0 16px rgba(245,158,11,0.3)" : "none",
              }}
            >
              {loading ? "⏳" : "▶"}
            </button>
          ...
          <p style={{ fontSize: "0.6rem", color: "#374151", textAlign: "center", marginTop: "0.4rem" }}>
            Enter para enviar • Shift+Enter para nova linha • Verifique normas no catálogo oficial ABNT
          </p>
        </div>
      </div>
